...
/**
 * Predefined test debts for common scenarios
 */
...
/**
 * Create a unique debt name for test isolation
 */
...
/**
 * Create a debt with a unique name
 */
...
/**
 * Sample debts for multi-debt scenarios
 */
