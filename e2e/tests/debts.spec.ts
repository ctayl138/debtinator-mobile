import { test, expect, testDebts, createMultiDebtScenario } from '../fixtures';

/**
 * E2E tests for Debt Management feature.
 * Tests cover: viewing debts, adding/editing/deleting debts, summary display.
 */
