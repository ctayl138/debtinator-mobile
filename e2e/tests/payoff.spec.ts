...
/**
 * E2E tests for Payoff Planning feature.
 * Tests cover: method selection, monthly payment input, summary display.
 */
test.describe('Payoff - Empty State', () => {
  ...
  test('can navigate to Payoff tab', async ({ payoffPage }) => {
    // If we get here, navigation succeeded - page is ready
    await expect(
