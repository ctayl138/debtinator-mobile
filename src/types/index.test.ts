/**
 * Runtime checks that type exports exist and sample shapes are valid.
 * TypeScript types are erased at runtime; we verify the module exports and that
 * objects conform to the expected shape when used in code.
 */
import type { Debt, DebtType, PayoffMethod, PayoffPlan, PayoffStep, PayoffSchedule } from './index';
